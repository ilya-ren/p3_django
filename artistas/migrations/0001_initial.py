# Generated by Django 4.1.2 on 2024-01-27 05:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_genero', models.ForeignKey(db_column='id_genero', on_delete=django.db.models.deletion.CASCADE, to='artistas.genero')),
            ],
        ),
    ]
